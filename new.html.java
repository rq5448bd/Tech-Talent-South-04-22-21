    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="center">
        ...
        <div class="card" style="width: 18rem;" >
            ...
            <img src="dell.png" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Inspiron 15 3000 Laptop</h5>
              <p class="card-text">processor
                ...
                color
                Soft Mint</p>
              <a href="#" class="btn btn-primary">Rs 70,000</a>
            </div>
          </div>
          
      </div>

      <a href="index2.html" class="btn btn-info">Back</a>
